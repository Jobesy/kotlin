...
internal class PropertiesProvider private constructor(private val project: Project) {
    ...
    val useClasspathSnapshot: Boolean
        get() {
            ...
            val gradleProperty = booleanProperty(CompilerSystemProperties.COMPILE_INCREMENTAL_WITH_ARTIFACT_TRANSFORM.property) ?: true
            val systemProperty = CompilerSystemProperties.COMPILE_INCREMENTAL_WITH_ARTIFACT_TRANSFORM.value.toBooleanLenient() ?: true
